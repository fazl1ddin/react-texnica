            ...
            <div className="window">
                <div className="warrantyContent">
                    ...
                    <div className="warrantyBox">
                        ...
                        <p><span className="dark">Потребитель/покупатель</span> — лицо, приобретающее или использующее товар исключительно для личных, семейных, домашних и иных нужд, не связанных с осуществлением предпринимательской деятельности;</p>
                        <p><span className="dark">Продавец</span> — организация независимо от её организационно-правовой формы, а также индивидуальный предприниматель, реализующие товары потребителям по договору купли-продажи.</p>
                        <p><span className="dark">Сервисный центр</span> — организация независимо от её организационно-правовой формы, а также индивидуальный предприниматель, осуществляющий гарантийное или платное обслуживание товаров. Сервисный центр не является аффилированной организацией продавца и не несёт ответственность перед потребителем за проданный товар.</p>
                        <p><span className="dark">Товар/Электротранспорт</span> — вид транспорта, использующий в качестве источника энергии электричество, в качестве привода электродвигатель. В соответствии с техническими характеристиками электротранспорт является технически сложным товаром. Товар входит в Перечень непродовольственных товаров надлежащего качества, не подлежащих возврату или обмену на аналогичный товар других размера, формы, габарита, фасона, расцветки или комплектации, утверждённому постановлением Правительства российской Федерации от 19.01.1998 № 55.</p>
                        <p><span className="dark">Категория товара</span> — подвид товара, имеющий отдельные критерии и характеристики относительно потребительских качеств.</p>
                        <p><span className="dark">Правила эксплуатации хранения транспортировки</span> — требования обязательные к соблюдению при пользовании товаром.</p>
                        <p><span className="dark">Идеальные условия эксплуатации</span> — рекомендованные продавцом и/или производителем условия эксплуатации товара при которых может быть достигнута максимальная среднестатистическая производительность электротранспорта (максимальная скорость, максимальный пробег при полном заряде аккумулятора, скорость торможения)</p>
                        <p><span className="dark">Гарантийный срок</span> — срок, при котором продавец осуществляет гарантийное обслуживание эректротранспорта.</p>
                    </div>
                    <div className="warrantyBox">
                    ...
                    <div className="warrantyBox">
                        ...
                        <p className="dark">2. Использование: </p>
                        ...
                        <p>К идеальным условиям эксплуатации относится совокупность условий, при соблюдении которых электротранспорт может проехать максимально заявленное расстояние от одного полного заряда батареи. <span className="dark">Такими условиями являются:</span></p>
                        <ul>
                    ...
                    <div className="warrantyBox">
                        <p className="yellow">Уважаемые клиенты, просим ознакомиться с информацией о правилах обращения к продавцу с претензиями относительно качества товара</p>
                    ...
                    <div className="warCon">
                        <h1>В случае наличия вопросов вы можете обратиться в наш Юридический отдел. </h1>
                        <h1>Адрес отдела по урегулированию претензий: <span className="blue">173004 г. В. Новгород ул. Тимура Фрунзе-Оловянка 17/3 оф. 5.</span></h1>
                        <h1>Тел. <span className="blue">+7 (996) 067-00-96</span></h1>
                        <h1>эл. почта: <span className="blue">mdsmbr@gmail.com</span></h1>
                    </div>
                </div>
            </div>
        </div>
